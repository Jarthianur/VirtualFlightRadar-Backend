 ...
 */
class FlarmFeed : public Feed
{
public:
    NOT_COPYABLE(FlarmFeed)
    DEFAULT_DTOR(FlarmFeed)
     ...
     */
    FlarmFeed(const std::string& name, const config::Properties& properties,
...
private:
    ...
    static parser::FlarmParser s_parser;

    std::shared_ptr<data::GpsData> m_gps;
};
