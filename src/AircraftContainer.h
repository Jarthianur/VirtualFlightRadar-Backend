...
public:
     ...
     */
    void insertAircraft(std::string&, long double, long double, int);
    void insertAircraft(std::string&, long double, long double, int, unsigned int, int, unsigned int, int, float, float);
