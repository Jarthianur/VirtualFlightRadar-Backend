...
void test_data(test::TestSuitesRunner& runner)
{
    ...
    /* ->test("write after outdated", []{
         ...
         double press = 1013.25;
         aprsParser.unpack(
             "FLRBBBBBB>APRS,qAS,XXXX:/201131h4900.00N/00800.00E'180/090/A=002000 id0ABBBBBB +010fpm
 +0.3rot", ac2); aprsParser.unpack(
             "FLRBBBBBB>APRS,qAS,XXXX:/201132h4900.00N/00800.00E'180/090/A=001000 id0ABBBBBB +010fpm
 +0.3rot", ac1); assertTrue(data.update(std::move(ac2)));
