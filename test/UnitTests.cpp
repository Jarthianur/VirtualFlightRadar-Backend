...
int main(int argc, char *argv[])
{
    ...
    parser::SBSParser pars_sbs;
    parser::APRSParser pars_aprs;
    parser::SensorParser pars_wind;
    parser::GPSParser pars_gps;
    ...
    describe<parser::SensorParser>("parser::SensorParser - unpack", runner)->test(
            ...
            [&eqs, &eqb]()
            {
                ...
                assert(vfrb::VFRB::msSensorData.getWVstr(), std::string(""), eqs);
            });
    ...
    describe<aircraft::AircraftProcessor>("Process Aircrafts", runner)->test(
            ...
            [&]()
            {
                ...
                assert(vfrb::VFRB::msAcCont.processAircrafts(), std::string(""), eqs);
                config::Configuration::filter_maxDist = INT32_MAX;
            });
    ...
    describe<config::ConfigReader>("read config", runner)->test("read", [&eqs]()
    {
